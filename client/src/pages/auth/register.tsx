...
const CITY_DATA: Record<string, Neighborhood[]> = {
  'الرياض': [
    { name: 'الملقا', lat: 24.8142, lng: 46.6111 },
    { name: 'الصحافة', lat: 24.8055, lng: 46.6375 },
    { name: 'الياسمين', lat: 24.8217, lng: 46.6567 },
    { name: 'النرجس', lat: 24.8450, lng: 46.6800 },
    { name: 'الروضة', lat: 24.7300, lng: 46.7700 },
    { name: 'السليمانية', lat: 24.7000, lng: 46.7000 },
    { name: 'العليا', lat: 24.7136, lng: 46.6753 },
    { name: 'المروج', lat: 24.7600, lng: 46.6600 },
    { name: 'النفل', lat: 24.7800, lng: 46.6600 },
    { name: 'الغدير', lat: 24.7700, lng: 46.6500 },
  ],
  'جدة': [
    { name: 'البلد', lat: 21.4833, lng: 39.1833 },
    { name: 'الحمراء', lat: 21.5282, lng: 39.1626 },
    { name: 'الشاطئ', lat: 21.6033, lng: 39.1166 },
    { name: 'الروضة', lat: 21.5732, lng: 39.1483 },
    { name: 'العزيزية', lat: 21.5499, lng: 39.1776 },
    { name: 'السلامة', lat: 21.5833, lng: 39.1500 },
    { name: 'المحيمدية', lat: 21.6167, lng: 39.1333 },
    { name: 'الفيصلية', lat: 21.5667, lng: 39.1833 },
    { name: 'أبحر الشمالية', lat: 21.7333, lng: 39.1167 },
    { name: 'المروة', lat: 21.6333, lng: 39.2000 },
  ],
  'الدمام': [
    { name: 'الشاطئ الشرقي', lat: 26.4731, lng: 50.1288 },
    { name: 'الريان', lat: 26.4180, lng: 50.1130 },
    { name: 'الفيصلية', lat: 26.3985, lng: 50.0760 },
    { name: 'الروضة', lat: 26.4420, lng: 50.0880 },
    { name: 'المزروعية', lat: 26.4520, lng: 50.1220 },
  ...
  'مكة المكرمة': [
    { name: 'أجياد', lat: 21.4179, lng: 39.8292 },
    { name: 'العزيزية', lat: 21.4166, lng: 39.8650 },
    { name: 'منى', lat: 21.4150, lng: 39.8930 },
    { name: 'المسفلة', lat: 21.4110, lng: 39.8230 },
    { name: 'الشبيكة', lat: 21.4210, lng: 39.8180 },
    { name: 'بطحاء قريش', lat: 21.3667, lng: 39.8333 },
    { name: 'الشرائع', lat: 21.4500, lng: 39.9500 },
    { name: 'النوارية', lat: 21.5500, lng: 39.7833 },
    { name: 'الرصيفة', lat: 21.4000, lng: 39.7833 },
    { name: 'الزايدي', lat: 21.3833, lng: 39.7333 },
  ],
  'المدينة المنورة': [
    { name: 'المنطقة المركزية', lat: 24.4686, lng: 39.6142 },
    { name: 'قباء', lat: 24.4392, lng: 39.6172 },
    { name: 'قربان', lat: 24.4536, lng: 39.6231 },
    { name: 'بضاعة', lat: 24.4727, lng: 39.6092 },
    { name: 'العيون', lat: 24.5200, lng: 39.5950 },
    { name: 'سيد الشهداء', lat: 24.4917, lng: 39.6125 },
    { name: 'العزيزية', lat: 24.4667, lng: 39.5333 },
    { name: 'الهجرة', lat: 24.4000, lng: 39.6167 },
    { name: 'الدويخلة', lat: 24.4833, lng: 39.6500 },
    { name: 'الخالدية', lat: 24.4500, lng: 39.6500 },
  ],
};
