      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10">
          ...
          <div className="bg-primary rounded-[32px] md:rounded-[40px] p-8 relative overflow-hidden flex flex-col justify-between shadow-xl min-h-[250px] border border-white/10">
            ...
            <button className="bg-secondary text-white py-4 rounded-2xl font-black text-sm z-10 w-full hover:bg-secondary-dark transition-all mt-8 active:scale-95 shadow-lg shadow-secondary/20">تصفحي الهدايا</button>
          </div>
